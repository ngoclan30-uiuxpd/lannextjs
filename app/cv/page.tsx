  ...
  return (
    <div className="editor-container-wrapper">
      ...
      <div className="floating-actions no-print">
        <a href="/CV.pdf" target="_blank" rel="noopener noreferrer" className="btn-floating-print" title={t("Download PDF", "Tải PDF")}>
          <Icons.Download />
          <span>{t("Download PDF", "Tải PDF")}</span>
        </a>
      </div>
              ...
              <aside className="cv-left-col">
                ...
                <div className="cv-section">
                  ...
                  <ul className="bullet-list-left">
                    ...
                    <li>{t("English (Professional Working)", "English (Professional Working)")}</li>
                  </ul>
                </div>
